      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {finalEyebrow && (
          <div className="flex items-center gap-2.5 mb-5">
            ...
            <span className="text-[11px] uppercase tracking-[0.22em] text-white/55 font-semibold">{finalEyebrow}</span>
          </div>
        )}
        ...
        {finalSubtitle && (
          <p className="mt-6 text-lg md:text-xl text-white/70 max-w-2xl">{finalSubtitle}</p>
        )}
      </div>
    </section>
  );
