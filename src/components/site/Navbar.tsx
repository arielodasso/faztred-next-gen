    ...
    >
      ...
      >
        ...
        >
          ...
          <nav className="hidden 2xl:flex min-w-0 items-center justify-center gap-8">
            {links.map((l) =>
          ...
          <div className="hidden 2xl:flex shrink-0 items-center gap-2 justify-self-end">
            <Link
              to="/login"
          ...
          <button
            className="2xl:hidden text-white p-2 -mr-2 justify-self-end"
            onClick={() => setOpen((v) => !v)}
            aria-label="Menú"
          >
        ...
        <div
          className={cn(
            "2xl:hidden overflow-hidden transition-all duration-300 mt-2 rounded-2xl border border-white/10 bg-[color:var(--surface-dark)]/90 backdrop-blur-xl",
